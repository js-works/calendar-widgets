...
import { AbstractDialogsController } from './dialogs';
...
// icons
import infoIcon from '../icons/bootstrap/info-square.icon';
import successIcon from '../icons/bootstrap/check2-square.icon';
import warningIcon from '../icons/bootstrap/exclamation-diamond.icon';
import errorIcon from '../icons/bootstrap/exclamation-triangle.icon';
import confirmationIcon from '../icons/bootstrap/question-diamond.icon';
import approvalIcon from '../icons/bootstrap/question-diamond.icon';
import promptIcon from '../icons/bootstrap/keyboard.icon';
