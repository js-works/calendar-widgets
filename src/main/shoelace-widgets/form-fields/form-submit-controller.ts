...
//
const userInteractedControls: WeakMap<FormControl, boolean> = new WeakMap();
...
export class FormSubmitController implements ReactiveController {
  ...
  constructor(
    ...
    this.options = {
      ...
      setValue: (input, value: unknown) => (input.value = value),
      ...options
    };
  ...
  setUserInteracted(el: FormControl, hasInteracted: boolean) {
