...
const shoelaceElementsLibrary: IconLibrary = {
  name: 'shoelace-elements',
...
unregisterIconLibrary(shoelaceElementsLibrary.name);

registerIconLibrary(shoelaceElementsLibrary.name, {
  resolver: shoelaceElementsLibrary.resolver
});
